...
class CraftingTableIIEntity(
    ...
    companion object {
        ...
        fun tick(
            world: World, pos: BlockPos, state: BlockState, entity: CraftingTableIIEntity
        ) {
            val player = world.getClosestPlayer(
                pos.x.toDouble(), pos.y.toDouble(), pos.z.toDouble(), 10.0, false
            ) ?: return
    ...
    override fun canTransferTo(
        hopperInventory: Inventory, slot: Int, stack: ItemStack
    ): Boolean {
        return false
    }
